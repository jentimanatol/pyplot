...
```bash
git clone https://github.com/YourUsername/DistributionVisualization.git
cd DistributionVisualization
```
...
The normal distribution visualization shows the classic bell-shaped curve with a mean of 0 and a standard deviation of 1.

The uniform distribution visualization includes detailed annotations for the requirements and calculations to find the probability of waiting times greater than 3.25 minutes.
...
Special thanks to the creators of the NumPy, Matplotlib, and SciPy libraries for their incredible tools that make data visualization and statistical analysis possible.
