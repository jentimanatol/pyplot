...
questions = [
    ...
    # Add the remaining 55 questions in this format here.
]
...
class QuizApp:
    def __init__(self, root):
        ...
        self.user_answers = [None] * len(questions)  # To store user answers
        self.score = 0

        # Top Frame for Navigation and Question Count
        ...
        for i in range(4):  # Assuming each question has up to 4 options
            rb = tk.Radiobutton(
