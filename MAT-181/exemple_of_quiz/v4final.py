...
class QuizApp:
    def __init__(self, root, questions):
        ...
        self.title_label = tk.Label(
            self.header_frame, text="Welcome to the Quiz", font=("Arial", 24), bg="#4CAF50", fg="white", pady=10
        )
    ...
    def show_review(self):
        """Display a review of all answers with a scroll bar."""
        ...
        # Populate the scrollable frame with questions and answers
        ...
        close_button = tk.Button(scrollable_frame, text="Close", command=review_window.destroy, font=("Arial", 12))
