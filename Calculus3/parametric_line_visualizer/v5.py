...
description = (
    ...
    "⌨️ Enter any value of t (default is 1) to find a point on the line.\n"
    "📄 'Print Data' shows parametric equations and key points below.\n"
    "🎨 'Visualize Line' displays a 3D plot."
)
