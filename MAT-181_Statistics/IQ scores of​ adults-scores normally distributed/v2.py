...
plt.text(0.5, 0.1, 'Anatolie Jentimir 2023', fontsize=20, color='gray', alpha=0.5, ha='center', va='center', rotation=45, transform=plt.gca().transAxes)
...
plt.savefig('normal_distribution_area_with_watermark.jpg', dpi=300)
