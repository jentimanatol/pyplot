...
# Title and labels
ax.set_title('🌿 Bamboo Plantation Land Required to Offset National CO₂ Emissions', fontsize=16, weight='bold', pad=20)
ax.set_ylabel('% of Total Land Area Needed', fontsize=12)
ax.set_xticks(x)
...
text_box = (
    "Formulas Used:\n"
    "• CO₂ Offset Area = CO₂ Emissions / Bamboo Absorption per sq mi\n"
    "• % Land Needed = (CO₂ Offset Area / Total Land Area) * 100\n"
    "\n"
    "Assumptions:\n"
    "- 1 sq mile = 640 acres\n"
...
ax.text(1.02, 0.5, text_box, transform=ax.transAxes, fontsize=9,
