...
co2_emissions = np.array([7890000, 3936000, 327905620])
...
bamboo_area = 0.03 * land_area_sqmi
...
bars2 = ax.bar(x + width/2, potential_reduction / 1e6, width, label='Potential Reduction (3% Bamboo)', color='lightgreen')

# Labels and title
ax.set_ylabel('CO₂ (Million Tons)', fontsize=12)
ax.set_title('CO₂ Emissions and Potential Reductions via Bamboo Plantations (3% Land Area)', fontsize=14, fontweight='bold')
ax.set_xticks(x)
