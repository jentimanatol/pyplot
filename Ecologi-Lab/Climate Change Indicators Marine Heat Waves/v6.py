...
df = pd.read_csv(data_file, skiprows=7, header=None)  # Skip the first 7 rows of informational data
...
# Print all data being plotted
print("\nData being plotted:")
print(df[['date_start', 'duration', 'intensity_mean']])
