...
# Step 5: Define the Function to Estimate and Visualize Contributions for Each Movie
def visualize_movie_contributions(movie):
    ...
    plt.bar(contributions.keys(), contributions.values(), color=['purple', 'blue', 'green', 'orange', 'red'])
    plt.title(f"Detailed Contribution Breakdown for '{movie['Title']}'", fontsize=16)
    plt.xlabel("Contribution Elements", fontsize=12)
