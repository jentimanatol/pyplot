...
def visualize_movie_contributions(movie):
    ...
    # Calculate Genre Contributions (with Director attribution)
    ...
    genre_director_contribution = f"Genre ({movie['Director']}) Contribution: ${genre_contribution:,.0f}"
    ...
    contributions = {
        genre_director_contribution: genre_contribution,
