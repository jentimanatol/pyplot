...
# Define your movies with their properties
movies = [
    {
        "Title": "Dream On",
        "Genre": "Drama",
...
# Step 5: Plot Sorted Movies
plt.figure(figsize=(14, 8))
plt.barh(sorted_movies['Title'], sorted_movies['Estimated Gross Profit ($)'], color='teal')
...
plt.savefig('Sorted_Movies_By_Gross_Profit.png')
plt.show()

print("The bar plot of sorted movies by estimated gross profit has been saved as 'Sorted_Movies_By_Gross_Profit.png'.")