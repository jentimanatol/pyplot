...
# Step 4: Define Contribution Weights
weight_director = 0.3
weight_genre = 0.3
weight_cast = 0.4

# Step 5: Define Function to Estimate and Visualize Contributions for Each Movie
def visualize_movie_contributions(movie):
    ...
    contributions = {
        ...
        **cast_contributions,  # Add individual cast members
        'Budget': movie['Budget'],
    ...
    bars = plt.bar(contributions.keys(), contributions.values(), color=['purple', 'blue'] + ['green'] * len(cast_contributions) + ['orange', 'red'])
